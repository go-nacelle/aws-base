...
func NewMockSqsEventHandlerInitializer() *MockSqsEventHandlerInitializer {
	return &MockSqsEventHandlerInitializer{
		HandleFunc: &SqsEventHandlerInitializerHandleFunc{
			defaultHook: func(context.Context, []events.SQSMessage, v2.Logger) (r0 error) {
				return
			},
		},
		InitFunc: &SqsEventHandlerInitializerInitFunc{
...
// NewStrictMockSqsEventHandlerInitializer creates a new mock of the
// sqsEventHandlerInitializer interface. All methods panic on invocation,
// unless overwritten.
func NewStrictMockSqsEventHandlerInitializer() *MockSqsEventHandlerInitializer {
	return &MockSqsEventHandlerInitializer{
		HandleFunc: &SqsEventHandlerInitializerHandleFunc{
			defaultHook: func(context.Context, []events.SQSMessage, v2.Logger) error {
				panic("unexpected invocation of MockSqsEventHandlerInitializer.Handle")
			},
		},
		InitFunc: &SqsEventHandlerInitializerInitFunc{
			defaultHook: func(context.Context) error {
				panic("unexpected invocation of MockSqsEventHandlerInitializer.Init")
			},
		},
	}
}
...
type surrogateMockSqsEventHandlerInitializer interface {
	Handle(context.Context, []events.SQSMessage, v2.Logger) error
...
type SqsEventHandlerInitializerHandleFunc struct {
	defaultHook func(context.Context, []events.SQSMessage, v2.Logger) error
	hooks       []func(context.Context, []events.SQSMessage, v2.Logger) error
...
func (m *MockSqsEventHandlerInitializer) Handle(v0 context.Context, v1 []events.SQSMessage, v2 v2.Logger) error {
...
// queue is empty.
func (f *SqsEventHandlerInitializerHandleFunc) SetDefaultHook(hook func(context.Context, []events.SQSMessage, v2.Logger) error) {
	f.defaultHook = hook
}
...
// action.
func (f *SqsEventHandlerInitializerHandleFunc) PushHook(hook func(context.Context, []events.SQSMessage, v2.Logger) error) {
	f.mutex.Lock()
...
func (f *SqsEventHandlerInitializerHandleFunc) SetDefaultReturn(r0 error) {
	f.SetDefaultHook(func(context.Context, []events.SQSMessage, v2.Logger) error {
		return r0
	})
}
...
func (f *SqsEventHandlerInitializerHandleFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, []events.SQSMessage, v2.Logger) error {
		return r0
	})
}

func (f *SqsEventHandlerInitializerHandleFunc) nextHook() func(context.Context, []events.SQSMessage, v2.Logger) error {
	f.mutex.Lock()
...
// parameter and result values of this invocation.
func (m *MockSqsEventHandlerInitializer) Init(v0 context.Context) error {
...
// parent MockSqsEventHandlerInitializer instance is invoked and the hook
// queue is empty.
func (f *SqsEventHandlerInitializerInitFunc) SetDefaultHook(hook func(context.Context) error) {
	f.defaultHook = hook
}
...
func (f *SqsEventHandlerInitializerInitFunc) PushHook(hook func(context.Context) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *SqsEventHandlerInitializerInitFunc) nextHook() func(context.Context) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// NewStrictMockSqsMessageHandlerInitializer creates a new mock of the
// sqsMessageHandlerInitializer interface. All methods panic on invocation,
// unless overwritten.
func NewStrictMockSqsMessageHandlerInitializer() *MockSqsMessageHandlerInitializer {
	return &MockSqsMessageHandlerInitializer{
		HandleFunc: &SqsMessageHandlerInitializerHandleFunc{
			defaultHook: func(context.Context, events.SQSMessage, v2.Logger) error {
				panic("unexpected invocation of MockSqsMessageHandlerInitializer.Handle")
			},
		},
		InitFunc: &SqsMessageHandlerInitializerInitFunc{
			defaultHook: func(context.Context) error {
				panic("unexpected invocation of MockSqsMessageHandlerInitializer.Init")
			},
		},
	}
}
...
// Handle delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockSqsMessageHandlerInitializer) Handle(v0 context.Context, v1 events.SQSMessage, v2 v2.Logger) error {
	r0 := m.HandleFunc.nextHook()(v0, v1, v2)
...
// queue is empty.
func (f *SqsMessageHandlerInitializerHandleFunc) SetDefaultHook(hook func(context.Context, events.SQSMessage, v2.Logger) error) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *SqsMessageHandlerInitializerHandleFunc) PushHook(hook func(context.Context, events.SQSMessage, v2.Logger) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *SqsMessageHandlerInitializerHandleFunc) nextHook() func(context.Context, events.SQSMessage, v2.Logger) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// Init delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockSqsMessageHandlerInitializer) Init(v0 context.Context) error {
	r0 := m.InitFunc.nextHook()(v0)
...
// parent MockSqsMessageHandlerInitializer instance is invoked and the hook
// queue is empty.
func (f *SqsMessageHandlerInitializerInitFunc) SetDefaultHook(hook func(context.Context) error) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *SqsMessageHandlerInitializerInitFunc) PushHook(hook func(context.Context) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *SqsMessageHandlerInitializerInitFunc) nextHook() func(context.Context) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
