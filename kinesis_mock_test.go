...
func NewMockKinesisEventHandlerInitializer() *MockKinesisEventHandlerInitializer {
	return &MockKinesisEventHandlerInitializer{
		HandleFunc: &KinesisEventHandlerInitializerHandleFunc{
			defaultHook: func(context.Context, []events.KinesisEventRecord, v2.Logger) (r0 error) {
				return
			},
		},
		InitFunc: &KinesisEventHandlerInitializerInitFunc{
...
// NewStrictMockKinesisEventHandlerInitializer creates a new mock of the
// kinesisEventHandlerInitializer interface. All methods panic on
// invocation, unless overwritten.
func NewStrictMockKinesisEventHandlerInitializer() *MockKinesisEventHandlerInitializer {
	return &MockKinesisEventHandlerInitializer{
		HandleFunc: &KinesisEventHandlerInitializerHandleFunc{
			defaultHook: func(context.Context, []events.KinesisEventRecord, v2.Logger) error {
				panic("unexpected invocation of MockKinesisEventHandlerInitializer.Handle")
			},
		},
		InitFunc: &KinesisEventHandlerInitializerInitFunc{
			defaultHook: func(context.Context) error {
				panic("unexpected invocation of MockKinesisEventHandlerInitializer.Init")
			},
		},
	}
}
...
type surrogateMockKinesisEventHandlerInitializer interface {
	Handle(context.Context, []events.KinesisEventRecord, v2.Logger) error
...
type KinesisEventHandlerInitializerHandleFunc struct {
	defaultHook func(context.Context, []events.KinesisEventRecord, v2.Logger) error
	hooks       []func(context.Context, []events.KinesisEventRecord, v2.Logger) error
...
func (m *MockKinesisEventHandlerInitializer) Handle(v0 context.Context, v1 []events.KinesisEventRecord, v2 v2.Logger) error {
...
// hook queue is empty.
func (f *KinesisEventHandlerInitializerHandleFunc) SetDefaultHook(hook func(context.Context, []events.KinesisEventRecord, v2.Logger) error) {
	f.defaultHook = hook
}
...
// action.
func (f *KinesisEventHandlerInitializerHandleFunc) PushHook(hook func(context.Context, []events.KinesisEventRecord, v2.Logger) error) {
	f.mutex.Lock()
...
func (f *KinesisEventHandlerInitializerHandleFunc) SetDefaultReturn(r0 error) {
	f.SetDefaultHook(func(context.Context, []events.KinesisEventRecord, v2.Logger) error {
		return r0
	})
}
...
func (f *KinesisEventHandlerInitializerHandleFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, []events.KinesisEventRecord, v2.Logger) error {
		return r0
	})
}

func (f *KinesisEventHandlerInitializerHandleFunc) nextHook() func(context.Context, []events.KinesisEventRecord, v2.Logger) error {
	f.mutex.Lock()
...
// parameter and result values of this invocation.
func (m *MockKinesisEventHandlerInitializer) Init(v0 context.Context) error {
...
// parent MockKinesisEventHandlerInitializer instance is invoked and the
// hook queue is empty.
func (f *KinesisEventHandlerInitializerInitFunc) SetDefaultHook(hook func(context.Context) error) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *KinesisEventHandlerInitializerInitFunc) PushHook(hook func(context.Context) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *KinesisEventHandlerInitializerInitFunc) nextHook() func(context.Context) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// NewStrictMockKinesisRecordHandlerInitializer creates a new mock of the
// kinesisRecordHandlerInitializer interface. All methods panic on
// invocation, unless overwritten.
func NewStrictMockKinesisRecordHandlerInitializer() *MockKinesisRecordHandlerInitializer {
	return &MockKinesisRecordHandlerInitializer{
		HandleFunc: &KinesisRecordHandlerInitializerHandleFunc{
			defaultHook: func(context.Context, events.KinesisEventRecord, v2.Logger) error {
				panic("unexpected invocation of MockKinesisRecordHandlerInitializer.Handle")
			},
		},
		InitFunc: &KinesisRecordHandlerInitializerInitFunc{
			defaultHook: func(context.Context) error {
				panic("unexpected invocation of MockKinesisRecordHandlerInitializer.Init")
			},
		},
	}
}
...
// Handle delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockKinesisRecordHandlerInitializer) Handle(v0 context.Context, v1 events.KinesisEventRecord, v2 v2.Logger) error {
	r0 := m.HandleFunc.nextHook()(v0, v1, v2)
...
// hook queue is empty.
func (f *KinesisRecordHandlerInitializerHandleFunc) SetDefaultHook(hook func(context.Context, events.KinesisEventRecord, v2.Logger) error) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *KinesisRecordHandlerInitializerHandleFunc) PushHook(hook func(context.Context, events.KinesisEventRecord, v2.Logger) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *KinesisRecordHandlerInitializerHandleFunc) nextHook() func(context.Context, events.KinesisEventRecord, v2.Logger) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// Init delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockKinesisRecordHandlerInitializer) Init(v0 context.Context) error {
	r0 := m.InitFunc.nextHook()(v0)
...
// parent MockKinesisRecordHandlerInitializer instance is invoked and the
// hook queue is empty.
func (f *KinesisRecordHandlerInitializerInitFunc) SetDefaultHook(hook func(context.Context) error) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *KinesisRecordHandlerInitializerInitFunc) PushHook(hook func(context.Context) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *KinesisRecordHandlerInitializerInitFunc) nextHook() func(context.Context) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
